(require :def-properties
	 ;; Unsure why was it here, leaving it commented out in case I come to need this sort of hack later.
	 ;; module.lisp just loaded the def-properties.lisp by hand, but since it required asdf itself,
	 ;; I'm not sure what the point is.
	 ;; (merge-pathnames #p"cl-def-properties/module.lisp" (uiop/pathname:pathname-directory-pathname *load-pathname*))
	 )

(defpackage :slynk-system-browser
  (:nicknames :ssb)
  (:use :cl)
  (:export
   :package-definitions
...
(in-package :slynk-system-browser)
